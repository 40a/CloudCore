# Dockerized CloudCore

This Docker container container is intended to be used to set up CloudCore and it's backend services including set up a 3 node MongoDB replica set.
