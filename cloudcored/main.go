...
import (
	...
	"github.com/CloudPac/CloudCore/api"
	"github.com/CloudPac/CloudCore/db"
	"github.com/CloudPac/CloudCore/exec/ansible"
	"github.com/CloudPac/CloudCore/exec/terraform"
	"github.com/CloudPac/CloudCore/log"
...
func main() {
	...
	logrus.Infoln("Cloud Core:", util.Version)
